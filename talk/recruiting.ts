...
export const recruiting: binotype.Site.Page = {
	...
	content:
		new showdown.Converter().makeHtml(`A step by step guide on how to recruit programmers including checklists and what to do and not to do. It also covers some insight what you can do to improve the likelihood of becoming recruited.
