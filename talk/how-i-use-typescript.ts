...
export const howIUseTypescript: binotype.Site.Page = {
	...
	content:
		new showdown.Converter().makeHtml(`This talk gives an overview of the benefits of using TypeScript and how to achieve them. It covers the following subjects:
