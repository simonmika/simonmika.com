document.addEventListener("DOMContentLoaded", function () {
	...
	for (var i = 0; i < quotes.length; i++) {
		var destinations = {
			...
			linkedin: "https://www.linkedin.com/sharing/share-offsite/?url=" + encodeURIComponent(document.URL),
			twitter:
				"https://twitter.com/intent/tweet?source=webclient&text=" +
				encodeURIComponent(quotes[i].textContent.trim() + " " + document.URL + " via @simonjmika"),
		}
